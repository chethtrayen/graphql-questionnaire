...
import { APIResponse, IQuestion, QuestionEditable, Question } from "@type";
...
const QuestionService: IQuestion = {
  create: async (questionnaireId: number, questions: QuestionEditable[], userId: number): APIResponse<Question[]> => {
    try {
