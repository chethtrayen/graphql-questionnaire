...
describe("User e2e login", () => {
  ...
  const bearerTkn = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNjY5OTQxMTI5fQ.84NoOMeWBhRFdx-qLIbZfImtNkLJAPoHPgJkisB_yxE";
  ...
  describe("POST /login", () => {
    ...
    it("should return a successful response", async () => {
      ...
      expect(response.body.data.createQuestionnaire).toEqual(expect.objectContaining({
