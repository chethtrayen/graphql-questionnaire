  ...
  describe('Create questionnaire', () => {
    ...
    describe('Successfully create questionnaire', () => {
      it("should return jwt token", async () => {
        ...
        const questionaires: Questionnaire | Error = await questionnaireService.create({title: mockQuestionnaire.title}, mockQuestionnaire.ownerId);
    ...
    describe('UnSuccessful user login', () => {
      it("should return an error",  () => {
          ...
          expect(() => questionnaireService.create({title: mockQuestionnaire.title}, undefined)).rejects.toThrow("Error: Failed to create group. No user logged in");
      })
